...
namespace BondTech.HotkeyManagement.Win
{
  ...
  public sealed class HotKeyManager : IMessageFilter, IDisposable // , IEnumerable, IEnumerable<GlobalHotKey>, IEnumerable<LocalHotKey>, IEnumerable<ChordHotKey>
  {
    ...
    {
      InternalForm = new Form();
      InternalForm.FormBorderStyle = FormBorderStyle.None;
      InternalForm.ShowInTaskbar = false;
      InternalForm.Left = -10;
      InternalForm.Top = -10;
      InternalForm.Width = 10;
      InternalForm.Height = 10;
      InternalForm.Show();
      InternalForm.Hide();
      this.SuppressException = false;
      this.FormHandle = InternalForm.Handle;
      this.Enabled = true;
    ...
    public bool PreFilterMessage(ref Message m)
    {
      ...
      switch ( (KeyboardMessages)m.Msg )
      {
        ...
        case ( KeyboardMessages.WmHotKey ):
          ...
          if ( InternalForm.Visible ) InternalForm.Hide();
          // ORDISOFTWARE MODIF BEGIN
