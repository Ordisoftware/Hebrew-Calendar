...
namespace AASharp
{
    public static class AASJupiter
    {
        ...
        { 
          ...
          new VSOP87Coefficient( 417,      1.036,      2.448       ),
        ...
        static readonly VSOP87Coefficient[] g_L1JupiterCoefficients =
        { 
        ...
        static readonly VSOP87Coefficient[] g_L2JupiterCoefficients =
        { 
        ...
        static readonly VSOP87Coefficient[] g_L3JupiterCoefficients =
        { 
        ...
        static readonly VSOP87Coefficient[] g_L4JupiterCoefficients =
        { 
        ...
        static readonly VSOP87Coefficient[] g_L5JupiterCoefficients =
        { 
        ...
        static readonly VSOP87Coefficient[] g_B0JupiterCoefficients =
        { 
        ...
        static readonly VSOP87Coefficient[] g_B1JupiterCoefficients =
        { 
        ...
        static readonly VSOP87Coefficient[] g_B2JupiterCoefficients =
        { 
        ...
        static readonly VSOP87Coefficient[] g_B3JupiterCoefficients =
        { 
        ...
        static readonly VSOP87Coefficient[] g_B4JupiterCoefficients =
        { 
        ...
        static readonly VSOP87Coefficient[] g_B5JupiterCoefficients =
        { 
          new VSOP87Coefficient( 1,  0.09, 522.58 )
        };
        
        static readonly VSOP87Coefficient[] g_R0JupiterCoefficients =
        { 
        ...
        static readonly VSOP87Coefficient[] g_R1JupiterCoefficients =
        { 
          ...
          new VSOP87Coefficient( 1646,   5.3095,     1066.4955   ),
        ...
        static readonly VSOP87Coefficient[] g_R2JupiterCoefficients =
        { 
        ...
        static readonly VSOP87Coefficient[] g_R3JupiterCoefficients =
        { 
        ...
        static readonly VSOP87Coefficient[] g_R4JupiterCoefficients =
        { 
        ...
        static readonly VSOP87Coefficient[] g_R5JupiterCoefficients =
        { 
        ...
        public static double EclipticLongitude(double JD, bool bHighPrecision)
        {
            ...
            //Calculate L0
            int nL0Coefficients = g_L0JupiterCoefficients.Length;
            double L0 = 0;
            int i;
