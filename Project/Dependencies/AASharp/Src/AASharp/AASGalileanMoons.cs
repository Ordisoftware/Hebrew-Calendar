...
namespace AASharp
{
    public static class AASGalileanMoons
    {
        ...
        private static void Rotations(double X, double Y, double Z, double I, double psi, double i, double omega, double lambda0, double beta0, ref double A6, ref double B6, ref double C6)
        {
