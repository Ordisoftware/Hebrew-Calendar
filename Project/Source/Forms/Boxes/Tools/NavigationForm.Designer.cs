namespace Ordisoftware.Hebrew.Calendar
{
  partial class NavigationForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.PanelMiddle.Controls.Add(this.LabelSunsetValue);
      ...
      resources.ApplyResources(this.LabelCurrentDayValue, "LabelCurrentDayValue");
      this.LabelCurrentDayValue.LinkColor = System.Drawing.Color.Navy;
      ...
      // PanelSeparatorTop
      // 
      this.PanelSeparatorTop.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
      resources.ApplyResources(this.PanelSeparatorTop, "PanelSeparatorTop");
      ...
      this.Controls.Add(this.PanelSeparatorBottom);
