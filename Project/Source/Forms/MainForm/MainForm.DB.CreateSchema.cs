        ...
        LockFileConnection.CheckTable(@"LunisolarDays",
                                      @"CREATE TABLE LunisolarDays 
                                        (
                                          ...
                                          LunarMonth INTEGER DEFAULT 0 NOT NULL,
                                          LunarDay INTEGER DEFAULT 0 NOT NULL,
                                          Sunrise TEXT DEFAULT '' NOT NULL,
                                          Sunset TEXT DEFAULT '' NOT NULL,
                                          Moonrise TEXT DEFAULT '' NOT NULL,
                                          Moonset TEXT DEFAULT '' NOT NULL,
                                          MoonriseType INTEGER DEFAULT 0 NOT NULL,
                                          IsNewMoon INTEGER DEFAULT 0 NOT NULL,
                                          IsFullMoon INTEGER DEFAULT 0 NOT NULL,
