namespace Ordisoftware.Hebrew.Calendar
{
  partial class MainForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      // SaveTextDialog
      // 
      this.SaveTextDialog.FileName = "Hebrew Calendar";
      ...
      // 
      resources.ApplyResources(this.EditEnumsAsTranslations, "EditExportDataEnumsAsTranslations");
      ...
      this.EditEnumsAsTranslations.Name = "EditExportDataEnumsAsTranslations";
      ...
      // SaveDataDialog
      // 
      this.SaveDataDialog.FileName = "Hebrew Calendar";
      // 
      // TrayIcon
      // 
