      ...
      try
      {
        ...
        foreach ( Data.DataSet.LunisolarDaysRow day in DataSet.LunisolarDays.Rows )
          try
          {
            ...
            string strDay = ( (MoonRiseOccuring)day.MoonriseType == MoonRiseOccuring.NextDay
                          ? "  "
            ...
            string strMoon = (MoonRiseOccuring)day.MoonriseType == MoonRiseOccuring.BeforeSet
            ...
            string strDesc = "";
            string s1 = AppTranslations.SeasonChange.GetLang((SeasonChange)day.SeasonChange);
