...
namespace Ordisoftware.Hebrew
{
  ...
  static partial class BooksNames
  {
    ...
    static public readonly NullSafeDictionary<Language, NullSafeOfStringDictionary<TanakBook>> Common
      = new NullSafeDictionary<Language, NullSafeOfStringDictionary<TanakBook>>()
      {
        {
          Language.FR, new NullSafeOfStringDictionary<TanakBook>
          {
            ...
            { TanakBook.Shemouel_II, "Samuel 1"},
            { TanakBook.Melakim_I, "Rois 1"},
            { TanakBook.Melakim_II, "Rois 1"},
