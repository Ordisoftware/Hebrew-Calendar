...
namespace Ordisoftware.Core
{
  ...
  static class ShellIcons
  {
    ...
    static ShellIcons()
    {
      ...
      Marshal.ThrowExceptionForHR(SHGetStockIconInfo(SHSTOCKICONID.SIID_INFO, SHGSI.SHGSI_ICON, ref sii));
      Information = Icon.FromHandle(sii.hIcon).ToBitmap();
      Marshal.ThrowExceptionForHR(SHGetStockIconInfo(SHSTOCKICONID.SIID_HELP, SHGSI.SHGSI_ICON, ref sii));
      ...
      Marshal.ThrowExceptionForHR(SHGetStockIconInfo(SHSTOCKICONID.SIID_ERROR, SHGSI.SHGSI_ICON, ref sii));
    ...
    static private extern Int32 SHGetStockIconInfo(SHSTOCKICONID siid, SHGSI uFlags, ref SHSTOCKICONINFO psii);
