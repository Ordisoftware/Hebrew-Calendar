  ...
  static public partial class Translations
  {
    ...
    static public readonly TranslationsDictionary NoticeShabat
      = new TranslationsDictionary
      {
        ...
        [Languages.FR] = "Le shabat est le \"jour du repos\" où l'on ne travaille pas pour obtenir un moyen de subsistance et où l'on exerce aucune activité créatrice. A moins d'une urgence vitale, on y repose le corps, les émotions et l'esprit. L'étude de la Torah y est une activité privilégiée." + Globals.NL2 +
