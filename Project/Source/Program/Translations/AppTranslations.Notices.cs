...
static partial class AppTranslations
{
  ...
  static public readonly TranslationsDictionary NoticeMonthsAndDays = new()
  {
    [Language.EN] = "The dates generated with the strict omer of the moon or the sun can differ from those in the Hebrew authorities' calendar, but astronomically speaking, there is no mistake, unless there is a problem to be corrected." + Globals.NL2 +
                    ...
                    "It can also happen that over 10 or 20 years there is a lag of one month due to Adar II due to the calculation rule used to determine the 1st Nissan and Pessa'h which is that Pessa'h is the 14th day of the first seasonal month in the first full moon following the spring equinox." + Globals.NL2 +
                    "But even with these lags, Pessa'h, according to the software, is still the first new moon following the spring equinox, and if it lags it falls at worst as the traditional calendar's Pessa'h Sheni, or vice versa, and within a few hours which generally remain within the 3% universal margin." + Globals.NL2 +
  ...
  static public readonly TranslationsDictionary NoticeParashah = new()
  {
    [Language.EN] = "The study of the Weekly Torah portion begins at Shim'hat Torah with the Bereshit section on 22 Tishri in the Land of Israel, or on 23 in Mitsraïm and in the desert, that is on the last day of Sukot, or the next day." + Globals.NL2 +
                    "It ends with full reading on Shabat, or the next Shabat if Shim'hat Torah occurs on Shabat. The day after Shabat we move on to the next Parashah that we study during the week by reading comments, listening to conferences, learning about science, and examining letters, words and verses, to read it in full on Shabat. And so on from week to week to go through the Torah in a year to build a better future world for oneself, for one's family, for one's community, for one's country, for the Nations, and for the species, thanks to Pessa'h, Shavuh'ot, Teruh'ah, Kipurim, and Sukot." + Globals.NL2 +
