...
static partial class AppTranslations
{
  ...
  static public readonly TranslationsDictionary NoticeMonthsAndDays = new()
  {
    [Language.EN] = "The dates generated can differ from those in the Hebrew authorities' calendar, but astronomically speaking, there is no mistake, unless there is a problem to be corrected." + Globals.NL2 +
                    "The software calculates the days according to the moon and various parameters relating to the stars and the seasons which mean that the dates can sometimes differ at certain points of the calendar established according to traditional standards." + Globals.NL2 +
                    "Thus the software can sometimes indicate the same days as the official calendar, and sometimes one to two or three days of shift, because of this new moon date which is sometimes not in astronomical correspondence, and the same goes for the calculation of holidays." + Globals.NL2 +
                    ...
                    "But even with these lags, Pesach, according to the software, is still the first new moon following the spring equinox, and if it lags it falls at worst as the traditional calendar's Pesach Sheni, or vice versa." + Globals.NL2 +
    ...
    [Language.FR] = "Les dates générées peuvent différer de celles du calendrier des autorités hébraïques, mais astronomiquement parlant, il n'y a pas d'erreur, à moins d'un problème à corriger." + Globals.NL2 +
                    ...
                    "Mais même avec ces décalages, Pessa'h, selon le logiciel, est toujours la première nouvelle lune qui suit l'équinoxe de printemps, et en cas de décalage il tombe au pire en tant que Pessa'h Sheni du calendrier traditionnel, ou vice versa." + Globals.NL2 +
                    "Le logiciel ne propose pas encore d'option pour générer un calendrier conforme à la Halakha et au Sod Ha'ibour (Connaissance sur le cycle des astres, ou Mystère de la lumière des astres en mouvement)."
  };
  ...
  {
    [Language.EN] = "The times of the Torah's celebrations are Pesach or Easter which is the liberation of illusions, Shavu'ot or Weeks which is the gift of knowledge, Teru'ah or Ringtone which is the joy of being freedom, Kipurim or Atonement which is the sorrows of losses, and Sukot or Tabernacles which is the construction of the future." + Globals.NL2 +
  ...
  static public readonly TranslationsDictionary NoticeParashah = new()
  {
    [Language.EN] = "The study of the Weekly Torah portion begins at Sim'hat Torah with the Bereshit section on 22 Tishri in the Land of Israel, or on 23 in Mitsraïm and in the desert, that is on the last day of Sukot, or the next day." + Globals.NL2 +
                    "It ends with full reading on Shabat, or the next Shabat if Sim'hat Torah occurs on Shabat. The day after Shabat we move on to the next Parashah that we study during the week by reading comments, listening to conferences, learning about science, and examining letters, words and verses, to read it in full on Shabat. And so on from week to week to go through the Torah in a year to build a better future world for oneself, for one's family, for one's community, for one's country, for the Nations, and for the species, thanks to Pesach, Shavu'ot, Teru'ah, Kipurim, and Sukot." + Globals.NL2 +
