...
static partial class AppTranslations
{
  ...
  static public readonly TranslationsDictionary NoticeMonthsAndDays = new()
  {
    [Language.EN] = "The dates generated with the strict omer of the moon or the sun can differ from those in the Hebrew authorities' calendar, but astronomically speaking, there is no mistake, unless there is a problem to be corrected." + Globals.NL2 +
                    ...
                    "But even with these lags, Pesach, according to the software, is still the first new moon following the spring equinox, and if it lags it falls at worst as the traditional calendar's Pesach Sheni, or vice versa, and within a few hours which generally remain within the 3% universal margin." + Globals.NL2 +
    ...
    [Language.FR] = "Les dates générées avec le omer strict de la lune ou du soleil peuvent différer de celles du calendrier des autorités hébraïques, mais astronomiquement parlant, il n'y a pas d'erreur, à moins d'un problème à corriger." + Globals.NL2 +
                    ...
                    "Le logiciel ne propose pas encore d'option pour générer un calendrier conforme à la Halakha du Sod Ha'ibour ou science des astres en mouvement."
  };
  ...
  static public readonly TranslationsDictionary NoticeParashah = new()
  {
    ...
    [Language.FR] = "L'étude de la Parashah de la semaine débute à Sim'hat Torah avec la section Bereshit le 22 Tishri en Terre d'Israël, ou le 23 en Mitsraïm et dans le désert, soit le dernier jour de Soukot, ou le lendemain. Elle se termine par la lecture complète lors du Shabat, ou le Shabat suivant si Sim'hat Torah a lieu un Shabat." + Globals.NL2 +
                    ...
                    "La génération des Parashot relatives aux Shabatot avec le omer de la lune ou du soleil sans le sod ha'ibour n'est pas garantie pour être traditionnelle d'autant que l'application génère des dates, quoi que basé sur le cycle lunaire, pouvant parfois un peu varier des calendriers officiels, surtout si on utilise le omer de la lune et encore plus avec le Shabat personnel."
  };
