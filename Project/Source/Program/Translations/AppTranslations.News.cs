  ...
  static partial class AppTranslations
  {
    ...
    static public readonly NullSafeDictionary<string, TranslationsDictionary> NoticeNewFeatures
      = new NullSafeDictionary<string, TranslationsDictionary>
      {
        ...
        {
          [Language.EN] = "Some fixes and improvements.",

          [Language.FR] = "Quelques corrections et améliorations."
        },
        ...
        ["8.0"] = new TranslationsDictionary
        {
          [Language.EN] = "Overall performances are optimized." + Globals.NL +
                          "Added option to set automatic computer lockout mode" + Globals.NL +
