  ...
  static public partial class AppTranslations
  {
    ...
    static public readonly TranslationsDictionary NoticeParashah
      = new TranslationsDictionary
      {
        ...
        [Language.FR] = "L'étude de la Parashah de la semaine débute à Sim'hat Torah avec la section Bereshit le 22 Tishri en Terre d'Israël (le pays conceptuel mondial des justes bienveillants dont le corps+esprit, et donc l'ADN, est dans une certaine mesure notable libéré de l'ignorance et du mal), ou le 23 en Mitsraïm et dans le désert, soit le dernier jour de Soukot, ou le lendemain." + Globals.NL2 +
