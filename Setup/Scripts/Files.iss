...
Source: ..\Project\Medias\Fonts\Hebrew.ttf; DestDir: {autofonts}; FontInstall: Hebrew Normal; Flags: onlyifdoesntexist uninsneveruninstall skipifsourcedoesntexist
