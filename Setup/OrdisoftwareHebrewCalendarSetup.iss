...
Name: {group}\{#MyAppName}\{cm:StartAndReset_msg,{#MyAppName}}; Filename: {app}\ResetSettings.bat; IconFilename: {app}\Application.ico; Parameters: /reset; Flags: runminimized
