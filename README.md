...
#### 2019.10.__ - Version 3.5

- Add Ctrl+T shortcut to go to today.
- Add option to define the delay to open the looming navigation popup.
- Improve reminder to change form color when passing the start date without waiting the delay.
- Improve supported min and max years that can be generated by using a VietnameseCalendar (1800-2199).
- Improve personal shabat setup to ask time of birth.
- Improve UI.
- Some fixes.
- Update help.
