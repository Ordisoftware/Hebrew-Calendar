...
- Add shutdown, hibernate and standby buttons to the auto lock session dialog box.
- Add option to stop current media playing to the auto lock session dialog box.
