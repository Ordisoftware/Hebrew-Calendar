...
6. [Frequently asked questions](#Frequently-asked-questions)
    ...
    - [What to do if the calendar month view is ugly?](#What-to-do-if-the-calendar-month-view-is-ugly)
    - [What to do if the application does not work normally despite restoring settings?](#What-to-do-if-the-application-does-not-work-normally-despite-restoring-settings)
    - [What are the times of celebration?](#What-are-the-times-of-celebration)
    - [What is Shabat?](#What-is-Shabat)
...
- Replace AASharp source dependency by the nuget package.
