...
6. [Frequently asked questions](#Frequently-asked-questions)
    - [How to install SQlite ODBC Driver?](How_to_install_SQlite_ODBC_Driver?)
    - [What to do in case of ODBC datasource connection error?](What_to_do_in_case_of_ODBC_datasource_connection_error?)
    - [What to do if the check update tells that the SSL certificate is wrong or expired?](What_to_do_if_the_check_update_tells_that_the_SSL_certificate_is_wrong_or_expired?)
    - [What to do if the calendar month view is ugly?](What_to_do_if_the_calendar_month_view_is_ugly?)
    - [What to do if the application does not work normally despite restoring settings?](What_to_do_if_the_application_does_not_work_normally_despite_restoring_settings?)
    - [What are the times of celebration?](What_are_the_times_of_celebration?)
    - [What is Shabat?](What_is_Shabat?)
